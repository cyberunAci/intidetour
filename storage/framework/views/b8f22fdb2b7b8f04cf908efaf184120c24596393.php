        ...
        <section class="d-flex justify-content-center align-items-center m-2">
            ...
            <div class="row m-3">
                <div class="col-lg-6 d-flex align-self-center">
                    <button class="m-2">Google Play</button>
                </div>
                <div class="col-lg-6 d-flex align-self-center">
                    <button class="m-2">App Store</button>
                </div>
            </div>
        </section>
    </div>
...
</section><?php /**PATH /home/krishna/Projet/intidetour/resources/views/clients/accueil/presentation.blade.php ENDPATH**/ ?>