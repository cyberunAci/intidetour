            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item <?php echo e($key==0?'active':''); ?>">
                        <img src="<?php echo e($galerie->photo->photo); ?>" height="300px" width="400px" class="" alt="" id="myImg">
                    </div>
...
</section><?php /**PATH /home/krishna/Projet/intidetour/resources/views/clients/accueil/galerie.blade.php ENDPATH**/ ?>