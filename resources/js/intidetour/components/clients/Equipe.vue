<template>
  <v-container fluid class="my-10 pa-0">
    <v-row>
      ...
      <v-col cols="12" md="3" height="auto" width="auto" class="d-flex flex-column justify-center">
        <v-card-title>L'équipe de Intidetour</v-card-title>
        ...
        <v-card-actions class="d-flex justify-end">
          <v-btn small color="primary">Plus d'information</v-btn>
        </v-card-actions>
      </v-col>
    </v-row>
  </v-container>
