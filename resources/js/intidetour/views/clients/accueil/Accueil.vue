  ...
  <v-container fluid class="ma-0 pa-0">
    <v-row class="ma-0 pa-0">
      <v-col class="ma-0 pa-0">
          <v-img src="https://via.placeholder.com/1000x450" alt class="align-center mb-2 pa-1" width="auto" height="750px">
            <v-col cols="12" md="5" sm="12" class="align-center">
              ...
              <v-row>
                <v-col>
                  <v-btn color="primary" width="100%">Google Play</v-btn>
                </v-col>
                <v-col>
                  <v-btn color="primary" width="100%">App Store</v-btn>
                </v-col>
              </v-row>
            </v-col>
          </v-img>
